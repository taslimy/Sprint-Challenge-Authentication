...
- It creates a way for users to show they they are logged in. So multiple users can be logged in all at once.
1. What does bcrypt do to help us store passwords in a secure manner.
- It hashes the password so it doesn't display in a string. It also makes it harder for hackers to decrypt it. 
1. What does bcrypt do to slow down attackers?
- Since it hashes the password the more complex the hashing the longer it will take for a brute force attack to be successfull. 
